...
\DeclareRobustCommand{\ghinlinelogo}{\includegraphics[height=\fontcharht\font`T]{figures/Logos/GitHub-Mark-120px-plus.png}}
...
%document header
\title[]{An open-source toolchain from molecular vibrations to detailed combustion:\\how (some) physical chemists and chemical engineers have escaped proprietary software}
%\subtitle{Subtitle}
%\titlegraphic{}
\author[]{Mark E. Fuller, Ph.D. and Kfir Kaplan}
