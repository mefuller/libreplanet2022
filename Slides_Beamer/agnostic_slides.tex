...
\begin{frame}{Our toolchain}
 \begin{itemize}
  ...
  \item Conversion of individual molecule results to thermodynamic properties and reaction rates with \textsc{ARC} (also other options)%PAPR/MESS?, TamKIN?
...
\begin{frame}{
 \hspace{-5mm}
 \includegraphics[height=10mm]{figures/Logos/avogadro2_64.png}
 Avogadro2
}
...
\vspace{-5mm}
\centering
 \includegraphics[width=\linewidth]{figures/avogadro_screenshot.png}
\end{frame}
...
\centering
\begin{tabular}{cc}
	\includegraphics[width=0.8\linewidth]{figures/flyer_top.jpg} & \\
	& \includegraphics[width=0.1\linewidth]{figures/qr.jpg}
\end{tabular}
